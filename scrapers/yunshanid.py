...
class YunshanIDScraper(BaseScraper):
    def __init__(self, default_server_idx: int = 0):
        super().__init__("yunshanid", "https://yunshanid.site", default_server_idx)
    ...
    async def get_latest(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Error fetching RSS for YunshanID: {e}")
